...
//const CountUrl = "?format=json&object=PACKAGE&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=PACKAGE&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=PACKAGE&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=PACKAGE&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=PACKAGE&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
