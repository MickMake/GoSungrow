...
func (t *STRUCTURE) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *STRUCTURE) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *STRUCTURE) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *STRUCTURE) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *STRUCTURE) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *STRUCTURE) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *STRUCTURE) Update(domain string, device string) (Update, error) {
	for range Only.Once {
