...
func (t *Queued) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Queued) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Queued) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Queued) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Queued) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Queued) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Queued) Update(domain string, device string) (Update, error) {
	for range Only.Once {
