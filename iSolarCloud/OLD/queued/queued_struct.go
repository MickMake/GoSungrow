...
//const CountUrl = "?format=json&object=queued&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=queued&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=queued&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=queued&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=queued&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
