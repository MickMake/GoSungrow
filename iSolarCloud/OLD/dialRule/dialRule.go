...
func (t *DialRule) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *DialRule) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *DialRule) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *DialRule) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *DialRule) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *DialRule) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *DialRule) Update(domain string, device string) (Update, error) {
	for range Only.Once {
