...
//const CountUrl = "?format=json&object=dialRule&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=dialRule&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=dialRule&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=dialRule&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=dialRule&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
