...
//const CountUrl = "?format=json&object=messageSession&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=messageSession&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=messageSession&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=messageSession&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=messageSession&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
