...
func (t *MessageSession) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *MessageSession) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *MessageSession) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *MessageSession) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *MessageSession) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *MessageSession) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *MessageSession) Update(domain string, device string) (Update, error) {
	for range Only.Once {
