...
func (t *Conference) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Conference) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Conference) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Conference) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Conference) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Conference) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Conference) Update(domain string, device string) (Update, error) {
	for range Only.Once {
