...
//const CountUrl = "?format=json&object=conference&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=conference&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=conference&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=conference&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=conference&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
