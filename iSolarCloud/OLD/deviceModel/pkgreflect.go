...
var Types = map[string]reflect.Type{
	"ButtonTypes": reflect.TypeOf((*ButtonTypes)(nil)).Elem(),
	...
	"CountResponseSingle": reflect.TypeOf((*CountResponseSingle)(nil)).Elem(),
	...
	"ExtraSettings": reflect.TypeOf((*ExtraSettings)(nil)).Elem(),
