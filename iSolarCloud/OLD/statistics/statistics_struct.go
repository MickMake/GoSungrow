...
//const CountUrl = "?format=json&object=statistics&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=statistics&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=statistics&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=statistics&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=statistics&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
