...
func (t *Statistics) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Statistics) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Statistics) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Statistics) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Statistics) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Statistics) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Statistics) Update(domain string, device string) (Update, error) {
	for range Only.Once {
