...
//const CountUrl = "?format=json&object=phoneNumber&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=phoneNumber&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=phoneNumber&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=phoneNumber&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=phoneNumber&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
