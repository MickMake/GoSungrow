...
func (t *PhoneNumber) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *PhoneNumber) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *PhoneNumber) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *PhoneNumber) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *PhoneNumber) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *PhoneNumber) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *PhoneNumber) Update(domain string, device string) (Update, error) {
	for range Only.Once {
