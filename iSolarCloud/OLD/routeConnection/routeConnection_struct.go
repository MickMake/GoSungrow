...
//const CountUrl = "?format=json&object=routeConnection&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=routeConnection&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=routeConnection&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=routeConnection&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=routeConnection&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
