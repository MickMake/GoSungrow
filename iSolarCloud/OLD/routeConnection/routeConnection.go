...
func (t *RouteConnection) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *RouteConnection) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *RouteConnection) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *RouteConnection) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *RouteConnection) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *RouteConnection) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *RouteConnection) Update(domain string, device string) (Update, error) {
	for range Only.Once {
