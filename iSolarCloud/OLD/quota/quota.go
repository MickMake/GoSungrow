...
func (t *Quota) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Quota) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Quota) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Quota) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Quota) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Quota) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Quota) Update(domain string, device string) (Update, error) {
	for range Only.Once {
