...
//const CountUrl = "?format=json&object=quota&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=quota&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=quota&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=quota&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=quota&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
