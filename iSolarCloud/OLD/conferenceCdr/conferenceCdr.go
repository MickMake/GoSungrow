...
func (t *ConferenceCdr) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *ConferenceCdr) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *ConferenceCdr) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *ConferenceCdr) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *ConferenceCdr) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *ConferenceCdr) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *ConferenceCdr) Update(domain string, device string) (Update, error) {
	for range Only.Once {
