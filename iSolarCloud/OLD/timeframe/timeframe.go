...
func (t *Timeframe) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Timeframe) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Timeframe) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Timeframe) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Timeframe) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Timeframe) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Timeframe) Update(domain string, device string) (Update, error) {
	for range Only.Once {
