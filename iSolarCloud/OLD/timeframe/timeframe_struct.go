...
//const CountUrl = "?format=json&object=timeframe&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=timeframe&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=timeframe&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=timeframe&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=timeframe&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
