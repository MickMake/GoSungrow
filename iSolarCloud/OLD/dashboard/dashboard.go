...
func (t *Dashboard) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Dashboard) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Dashboard) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Dashboard) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Dashboard) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Dashboard) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Dashboard) Update(domain string, device string) (Update, error) {
	for range Only.Once {
