...
//const CountUrl = "?format=json&object=dashboard&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=dashboard&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=dashboard&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=dashboard&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=dashboard&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
