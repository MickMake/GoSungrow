...
func (t *SmsNumber) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *SmsNumber) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *SmsNumber) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *SmsNumber) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *SmsNumber) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *SmsNumber) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *SmsNumber) Update(domain string, device string) (Update, error) {
	for range Only.Once {
