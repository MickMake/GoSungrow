...
//const CountUrl = "?format=json&object=smsNumber&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=smsNumber&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=smsNumber&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=smsNumber&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=smsNumber&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
