...
var Types = map[string]reflect.Type{
	"Call": reflect.TypeOf((*Call)(nil)).Elem(),
	"CallRequestCountRequest": reflect.TypeOf((*CallRequestCountRequest)(nil)).Elem(),
	"CallRequestCountResponse": reflect.TypeOf((*CallRequestCountResponse)(nil)).Elem(),
	"CallRequestReadRequest": reflect.TypeOf((*CallRequestReadRequest)(nil)).Elem(),
	"CallRequestReadResponse": reflect.TypeOf((*CallRequestReadResponse)(nil)).Elem(),
...
var Consts = map[string]reflect.Value{
	"CallRequestCountUrl": reflect.ValueOf(CallRequestCountUrl),
	"CallRequestReadUrl": reflect.ValueOf(CallRequestReadUrl),
}
