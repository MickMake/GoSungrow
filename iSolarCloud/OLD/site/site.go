...
func (t *Site) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Site) Count(domain string) Count {
	for range Only.Once {
...
func (t *Site) Create(domain string) Create {
	for range Only.Once {
...
func (t *Site) Delete(domain string, site string) Delete {
	for range Only.Once {
...
func (t *Site) List(domain string) List {
	for range Only.Once {
...
func (t *Site) Read(domain string) Read {
	for range Only.Once {
...
func (t *Site) Update(domain string) Update {
	for range Only.Once {
