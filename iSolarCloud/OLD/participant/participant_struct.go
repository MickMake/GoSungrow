...
//const CountUrl = "?format=json&object=participant&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=participant&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=participant&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=participant&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=participant&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
