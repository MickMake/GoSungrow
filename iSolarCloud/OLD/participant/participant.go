...
func (t *Participant) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Participant) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Participant) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Participant) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Participant) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Participant) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Participant) Update(domain string, device string) (Update, error) {
	for range Only.Once {
