...
//const CountUrl = "?format=json&object=dialPlan&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=dialPlan&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=dialPlan&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=dialPlan&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=dialPlan&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
