...
func (t *DialPlan) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *DialPlan) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *DialPlan) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *DialPlan) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *DialPlan) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *DialPlan) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *DialPlan) Update(domain string, device string) (Update, error) {
	for range Only.Once {
