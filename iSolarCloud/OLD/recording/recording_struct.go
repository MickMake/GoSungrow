...
//const CountUrl = "?format=json&object=recording&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=recording&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=recording&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=recording&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=recording&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
