...
func (t *Recording) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Recording) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Recording) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Recording) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Recording) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Recording) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Recording) Update(domain string, device string) (Update, error) {
	for range Only.Once {
