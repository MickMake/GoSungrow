...
//const CountUrl = "?format=json&object=phoneConfiguration&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=phoneConfiguration&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=phoneConfiguration&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=phoneConfiguration&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=phoneConfiguration&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
