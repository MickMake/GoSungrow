...
func (t *PhoneConfiguration) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *PhoneConfiguration) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *PhoneConfiguration) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *PhoneConfiguration) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *PhoneConfiguration) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *PhoneConfiguration) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *PhoneConfiguration) Update(domain string, device string) (Update, error) {
	for range Only.Once {
