...
func (t *Profile) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Profile) Create(territory string) Create {
	for range Only.Once {
...
func (t *Profile) Delete(territory string) Delete {
	for range Only.Once {
...
func (t *Profile) Update(territory string) Update {
	for range Only.Once {
