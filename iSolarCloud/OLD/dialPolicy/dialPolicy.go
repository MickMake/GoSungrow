...
func (t *DialPolicy) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *DialPolicy) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *DialPolicy) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *DialPolicy) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *DialPolicy) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *DialPolicy) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *DialPolicy) Update(domain string, device string) (Update, error) {
	for range Only.Once {
