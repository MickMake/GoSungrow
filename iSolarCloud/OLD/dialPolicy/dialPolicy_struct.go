...
//const CountUrl = "?format=json&object=dialPolicy&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=dialPolicy&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=dialPolicy&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=dialPolicy&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=dialPolicy&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
