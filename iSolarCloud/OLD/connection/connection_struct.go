...
//const CountUrl = "?format=json&object=connection&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=connection&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=connection&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=connection&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=connection&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
