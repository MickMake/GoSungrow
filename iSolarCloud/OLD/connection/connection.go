...
func (t *Connection) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Connection) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Connection) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Connection) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Connection) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Connection) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Connection) Update(domain string, device string) (Update, error) {
	for range Only.Once {
