...
//const CountUrl = "?format=json&object=meeting&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=meeting&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=meeting&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=meeting&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=meeting&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
