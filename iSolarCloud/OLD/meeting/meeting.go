...
func (t *Meeting) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Meeting) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Meeting) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Meeting) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Meeting) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Meeting) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Meeting) Update(domain string, device string) (Update, error) {
	for range Only.Once {
