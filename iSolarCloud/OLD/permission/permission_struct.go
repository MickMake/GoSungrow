...
//const CountUrl = "?format=json&object=permission&action=count"
type Count struct {
	Url      *url.URL
...
//const CreateUrl = "?format=json&object=permission&action=create"
type Create struct {
	Url      *url.URL
...
//const DeleteUrl = "?format=json&object=permission&action=delete"
type Delete struct {
	Url      *url.URL
...
//const ListUrl = "?format=json&object=permission&action=list"
type List struct {
	Url      *url.URL
	Request  ListRequest
...
//const ReadUrl = "?format=json&object=permission&action=read"
type Read struct {
	Url      *url.URL
	Request  ReadRequest
