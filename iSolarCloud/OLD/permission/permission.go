...
func (t *Permission) SetBaseUrl(u string) error {
	for range Only.Once {
		if u == "" {
...
func (t *Permission) Count(domain string) (Count, error) {
	for range Only.Once {
...
func (t *Permission) Create(domain string, device string) (Create, error) {
	for range Only.Once {
...
func (t *Permission) Delete(domain string, device string) (Delete, error) {
	for range Only.Once {
...
func (t *Permission) List(domain string) (List, error) {
	for range Only.Once {
...
func (t *Permission) Read(domain string) (Read, error) {
	for range Only.Once {
...
func (t *Permission) Update(domain string, device string) (Update, error) {
	for range Only.Once {
