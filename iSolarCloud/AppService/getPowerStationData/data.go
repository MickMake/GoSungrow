...
type ResultData struct {
	DayPowerQuantityTotal valueTypes.UnitValue `json:"day_power_quantity_total"`
	DayTotalProfit        valueTypes.UnitValue `json:"day_total_profit"`
	P34048List            []valueTypes.Float   `json:"p34048List" PointId:"p34048" PointUnitFrom:"p34048_unit"`
	P34048Unit            string        `json:"p34048_unit"`
	P83012List            []valueTypes.Float   `json:"p83012List" PointId:"p83012" PointUnitFrom:"p83012_unit"`
	P83012Unit            string        `json:"p83012_unit"`
	P83033List            []valueTypes.Float   `json:"p83033List" PointId:"p83033" PointUnitFrom:"p83033_unit"`
	P83033Unit            string        `json:"p83033_unit"`
	P83106List            []valueTypes.Float   `json:"p83106List" PointId:"p83106" PointUnitFrom:"p83106_unit"`
	P83106Unit            string        `json:"p83106_unit"`

	P83022List []valueTypes.Float `json:"p83022List" PointId:"p83022" PointUnitFrom:"p83022_unit"` // Used for Year, Month, Day
	P83022Unit string      `json:"p83022_unit"`                                             // Used for Year, Month, Day
	P83118List []valueTypes.Float `json:"p83118List" PointId:"p83118" PointUnitFrom:"p83118_unit"` // Used for Year, Month, Day
...
func (e *EndPoint) GetData() api.DataMap {
	...
	for range Only.Once {
		...
		// entries.AddUnitValue(name + ".DayPowerQuantityTotal", e.Request.PsId.String(), "DayPowerQuantityTotal", "", "", valueTypes.NewDateTime(""), uv)
		//
		// uv = api.SetUnitValueString(e.Response.ResultData.DayTotalProfit.Value, e.Response.ResultData.DayTotalProfit.Unit)
		// entries.AddUnitValue(name + ".DayTotalProfit", e.Request.PsId.String(), "DayTotalProfit", "", "", valueTypes.NewDateTime(""), uv)
		//
		// for _, d := range e.Response.ResultData.P34048List {
		// 	uv = api.SetUnitValueString(d, e.Response.ResultData.P34048Unit)
		// 	entries.AddUnitValue(name + ".p34048", e.Request.PsId.String(), "p34048", "", "", valueTypes.NewDateTime(""), uv)
		// }
		//
		...
		// 	entries.AddUnitValue(name + ".p83033", e.Request.PsId.String(), "p83033", "", "", valueTypes.NewDateTime(""), uv)
		// }
		//
		// for _, d := range e.Response.ResultData.P83106List {
		// 	uv = api.SetUnitValueString(d, e.Response.ResultData.P83106Unit)
		// 	entries.AddUnitValue(name + ".p83106", e.Request.PsId.String(), "p83106", "", "", valueTypes.NewDateTime(""), uv)
		// }
		//
		// for _, d := range e.Response.ResultData.P83022List {
		// 	uv = api.SetUnitValueString(d, e.Response.ResultData.P83022Unit)
		// 	entries.AddUnitValue(name + ".p83022", e.Request.PsId.String(), "p83022", "", "", valueTypes.NewDateTime(""), uv)
		// }
		//
		// for _, d := range e.Response.ResultData.P83118List {
		// 	uv = api.SetUnitValueString(d, e.Response.ResultData.P83118Unit)
		// 	entries.AddUnitValue(name + ".p83118", e.Request.PsId.String(), "p83118", "", "", valueTypes.NewDateTime(""), uv)
		// }
	}
